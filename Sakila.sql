...
-- Setup by first using sakila database
USE sakila;

-- 1a. Display the first and last names of all actors from the table `actor`.USE sakila;
...
AS `Count` FROM actor GROUP BY last_name;
